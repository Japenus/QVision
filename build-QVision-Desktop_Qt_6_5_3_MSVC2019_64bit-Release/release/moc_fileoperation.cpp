...
#include "../../QVision/src/fileoperation.h"
...
static constexpr auto qt_meta_stringdata_CLASSfileOperationENDCLASS = QtMocHelpers::stringData(
    "fileOperation"
);
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSfileOperationENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSfileOperationENDCLASS_t qt_meta_stringdata_CLASSfileOperationENDCLASS = {
    {
        QT_MOC_LITERAL(0, 13)   // "fileOperation"
    },
    "fileOperation"
};
