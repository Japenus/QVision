...
// BeizerCurve::BeizerCurve(const QVector<Point> &points)
//     : QObject(nullptr), m_pointsInput(points)
// {
//     //Nothing
// }

// void BeizerCurve::Calculate(int outPointNum)
// {
...
//     double t = 0;
//     qDebug() << "BeizerCurve::Calculate step:" << step;
...
// QVector<BeizerCurve::Point> BeizerCurve::GetOutputPoints()
// {
//     return this->m_pointsOutput;
// }

// uint64_t BeizerCurve::combination(int n, int i)
// {
//     uint32_t key = (n << 16) | i;
...
// double BeizerCurve::bernstein(int n, int i, double t)
// {
//     double basis;
//     double ti;  // t^i
//     double tni; // (1 - t)^i
